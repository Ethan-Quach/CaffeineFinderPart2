...
public class CaffeineListActivity extends AppCompatActivity
    ...
    // Member variable to access Google Play services (LOCATION SERVICES)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Build new GoogleApiClient if none exists
        if (mGoogleApiClient == null) {
            // Note that we don't make a new GoogleApiClient().
            // The interface for that is butt ugly and bulky.
